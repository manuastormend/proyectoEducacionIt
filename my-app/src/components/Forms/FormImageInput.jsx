...
function FormImageInput ({label, placeholder, className, propiedad, ctxType})  {
    ...
    return <>
        ...
        <input className={clase} type="file" accept="image/*"  placeholder={placeholder} value={input} onChange={(e)=>setInput(e.currentTarget.value)}></input>
